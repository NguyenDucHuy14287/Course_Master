...
class MCVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by MCParser#other_stmt.
    ...
    # Visit a parse tree produced by MCParser#indexExp.
    def visitIndexExp(self, ctx:MCParser.IndexExpContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MCParser#indexFirstExp.
